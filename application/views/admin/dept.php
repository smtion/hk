    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">부서 <span v-show="!data.id">등록</span><span v-show="data.id">정보 변경</span></h4>
        </div>
...
var vm = new Vue({
  ...
  methods: {
    ...
    getList: function (page) {
      ...
      axios.get('/api/admin/dept?' + params).then(function (response) {
