 <div id="purchase-cost-list">
  <div class="title">간접비 목록</div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">간접비 등록</h4>
        </div>
...
var vm = new Vue({
  ...
  methods: {
    ...
    edit: function (index) {
      ...
      axios.get('/api/purchase/cost_detail2?' + params).then(function (response) {
    ...
    getOptionName: function () {
      axios.get('/api/purchase/cost_parts_name').then(function (response) {
        if (response.status == 200) {
    ...
    getList: function (page) {
      ...
      axios.get('/api/purchase/cost_list?' + params).then(function (response) {
        if (response.status == 200) {
    ...
    create: function () {
      ...
      axios.post('/api/purchase/cost_list', vm.data).then(function (response) {
    ...
    update: function () {
      ...
      axios.patch('/api/purchase/cost_list', vm.data).then(function (response) {
        if (response.status == 200) {
          alert('변경되었습니다.');
          $('#modalCreate').modal('hide');
          vm.reload();
