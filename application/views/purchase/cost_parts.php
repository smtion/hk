<div id="purchase-cost-parts">
  <div class="title">간접비 상세</div>
  ...
  <div class="row">
    <div class="col-sm-offset-2 col-sm-2">
      <select class="form-control" v-model="search">
        ...
        <option value="name">간접비 구성 명칭</option>
        <option value="type">간접비 구성 구분</option>
        <option value="values">간접비 구성 항목</option>
      </select>
    </div>
    <div class="col-sm-4">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">간접비 상세 등록</h4>
        </div>
        <div class="modal-body">
          <div class="form-horizontal">
            <div class="form-group">
              <label class="col-sm-4 control-label">간접비 구성 코드</label>
              <div class="col-sm-8">
...
var vm = new Vue({
  ...
  methods: {
    ...
    getList: function (page) {
      ...
      axios.get('/api/purchase/cost_parts?' + params).then(function (response) {
        if (response.status == 200) {
